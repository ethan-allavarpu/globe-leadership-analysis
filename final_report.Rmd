...
plot(pca_x[, 1:2],
     xlim = range(pca_x[, 1]) + c(-0.5, 0.5),
     ylim = range(pca_x[, 2]) + c(-0.5, 0.5),
     col = (col_palette[seq_len(4) + 3])[best_4$cluster],
     pch = 19, cex = 0.75, las = 1,
     main = "Country Clusters by First Two Principal Components")
```
```{r}

...
\begin{center}\includegraphics[width=0.95\linewidth]{report_files/figure-latex/society-1} \end{center}
...
\begin{center}\includegraphics[width=0.85\linewidth]{report_files/figure-latex/kmeans_count-1} \end{center}

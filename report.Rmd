...
A single, complete observation from the leadership survey is for a specific culture (either a country or a subcountry) about the following characteristics: `r paste(colnames(leadership), collapse = "; ")`.

A single, complete observation from the society and culture survey has a similar structure as the leadership survey--each observation is for a specific culture (either a country or a subcountry) about the following characteristics: `r paste(trimws(colnames(society)), collapse = "; ")`.
...
melt(characteristic_values) %>%
  ...
  labs(title = "Figure 5: Median Leadership Category Scores by Cluster",

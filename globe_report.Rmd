...
A single, complete observation from the leadership survey is for a specific culture (either a country or a subcountry) and has `r ncol(leadership)` variables: one for the country, one for the country name, one for the country cluster, and then `r ncol(leadership) - 3` other variables about leadership qualities (e.g., `r paste(sample(colnames(leadership)[-c(1, 2, 30)], size = 3), collapse = "; ")`).

A single, complete observation from the society and culture survey has a similar structure as the leadership survey--each observation is for a specific culture (either a country or a subcountry) and has `r ncol(society)` variables: one for the country, one for the country name, one for the country cluster, and then `r ncol(society) - 3` other variables about society and culture qualities (e.g., `r paste(sample(colnames(society)[-c(1, 2, 21)], size = 3), collapse = "; ")`).
...
```{r cluster_values, fig.height=7, fig.width=7}
